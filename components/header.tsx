...
export default function Header() {
  ...
  return (
    <header className="relative flex w-full min-h-screen items-center justify-center p-8">
      ...
      />
      <motion.div
        className="backdrop-blur-lg bg-white bg-blend-saturation shadow-2xl rounded-3xl p-8 md:p-12 sticky max-w-3xl text-center"
      ...
      >
        <h1 className="text-6xl font-bold max-w-3xl">
          ...
          change, it’s <span className="text-blue-500">solar power</span>.
        </h1>
        <p className="mt-5 text-2xl mx-auto text-stone-600 max-w-lg">
